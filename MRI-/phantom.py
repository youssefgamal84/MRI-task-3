...
def _T1_phantom():
    #  Modified version of Shepp & Logan's head phantom,
    #  adjusted to improve contrast.  Taken from Toft.
    return [[1.533, .69, .92, 0, 0, 0],
            [3.667, .6624, .8740, 0, -.0184, 0],
            [0.4, .1100, .3100, .22, 0, -18],
            [0.4, .1600, .4100, -.22, 0, 18],
...
def _T2_phantom():
    #  Modified version of Shepp & Logan's head phantom,
    #  adjusted to improve contrast.  Taken from Toft.
    return [[0.2, .69, .92, 0, 0, 0],
            [0.2, .6624, .8740, 0, -.0184, 0],
            [-0.1, .1100, .3100, .22, 0, -18],
            [-0.1, .1600, .4100, -.22, 0, 18],
            [-0.08, .2100, .2500, 0, .35, 0],
            [-0.02, .0460, .0460, 0, .1, 0],
            [-0.02, .0460, .0460, 0, -.1, 0],
            [-0.02, .0460, .0230, -.08, -.605, 0],
            [-0.02, .0230, .0230, 0, -.606, 0],
            [-0.02, .0230, .0460, .06, -.605, 0]]
