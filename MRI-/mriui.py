...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 531, 492))
        self.page.setObjectName("page")
        self.formLayout = QtWidgets.QFormLayout(self.page)
        self.formLayout.setObjectName("formLayout")
        self.prepSelc = QtWidgets.QComboBox(self.page)
        ...
        self.InvTimeText = QtWidgets.QLabel(self.page)
        self.InvTimeText.setMaximumSize(QtCore.QSize(16777215, 20))
        self.InvTimeText.setObjectName("InvTimeText")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.InvTimeText)
        self.Invtime = QtWidgets.QLineEdit(self.page)
        self.Invtime.setObjectName("Invtime")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.Invtime)
        self.T2prep = QtWidgets.QLineEdit(self.page)
        self.T2prep.setMaximumSize(QtCore.QSize(150, 200))
        self.T2prep.setObjectName("T2prep")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.T2prep)
        self.spacingSW = QtWidgets.QLineEdit(self.page)
        self.spacingSW.setObjectName("spacingSW")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.spacingSW)
        self.label_4 = QtWidgets.QLabel(self.page)
        self.label_4.setText("")
        self.label_4.setObjectName("label_4")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.label_4)
        self.T2prepText = QtWidgets.QLabel(self.page)
        self.T2prepText.setMaximumSize(QtCore.QSize(16777215, 20))
        self.T2prepText.setObjectName("T2prepText")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.T2prepText)
        self.spacingText = QtWidgets.QLabel(self.page)
        self.spacingText.setMaximumSize(QtCore.QSize(16777215, 20))
        self.spacingText.setObjectName("spacingText")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.spacingText)
        self.toolBox.addItem(self.page, "")
        self.page_2 = QtWidgets.QWidget()
        self.page_2.setGeometry(QtCore.QRect(0, 0, 531, 461))
        self.page_2.setObjectName("page_2")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.page_2)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.acqBox = QtWidgets.QComboBox(self.page_2)
        self.acqBox.setObjectName("acqBox")
        self.acqBox.addItem("")
        self.acqBox.addItem("")
        self.acqBox.addItem("")
        self.gridLayout_2.addWidget(self.acqBox, 1, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), _translate("MainWindow", "Preparation"))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), _translate("MainWindow", "Acquisition"))
